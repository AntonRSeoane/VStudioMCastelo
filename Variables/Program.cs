...
namespace Variables
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Programa que a partir de la base y de la altura, calcula el área de un triángulo
            double BaseTriángulo, Altura, Área;
            BaseTriángulo = 9;
            Altura = 7.5;
            Área = (BaseTriángulo * Altura) / 2;
            Console.WriteLine("El área del triángulo es " + Área);
            Console.ReadLine();
