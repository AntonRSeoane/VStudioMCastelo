...
namespace Tema7
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("ADVERTENCIA: \n SI TIENE PROBLEMAS MENTALES O CARDÍACOS, SE LE RECOMIENDA QUE ACUDA CON UN PROFESIONAL ANTES DE JUGAR, YA QUE PUEDE RESULTAR DEMASIADO ASOMBROSO PARA ALGUNOS PÚBLICOS.");
            Console.ReadLine();
            Console.Clear();
            Thread.Sleep(5000);
